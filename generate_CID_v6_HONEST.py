...
# =================================================================================
# CID MANUSCRIPT v6: SCIENTIFICALLY HONEST VERSION
# Re-analysis of public data with proper framing
# =================================================================================
doc = Document()

# Title Page - HONEST FRAMING
...
doc.add_paragraph(
    ...
    "(1) GSE167232, containing BAL samples from TB patients and healthy controls (Pisu et al., J Exp Med 2021) [5]; and "
    "(2) GSE287288, containing PBMC data from TB patients (Gong et al., 2025) [6]. "
...
# Table 2: CPI Values - VERIFIED FROM CSV
...
doc.add_paragraph(
    "Transcription factor motif analysis of accessible regions in BAL macrophages identified enrichment for AP-1 family members (FOS, JUN) and BATF, "
...
# Table 3: MMP Analysis - HYPOTHESIS-GENERATING
...
doc.add_paragraph(
    "BAL data: GSE167232 (Pisu et al., J Exp Med 2021) - Single-cell RNA-seq of BAL from TB patients and healthy controls. "
    "PBMC data: GSE287288 (Gong et al., 2025) - Single-cell sequencing of PBMC from disseminated TB patients. "
    "For details of original sample collection and processing, refer to the original publications [5,6]."
)
